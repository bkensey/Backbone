 ...
 * https://android.googlesource.com/platform/frameworks/base/+/jb-release/core/java/android/os/ImageAsyncTask.java
 *
 * so that threading behavior on all OS versions is the same and we can tweak behavior by using
 * executeOnExecutor() if needed.
 *
 * There are 3 changes in this copy of ImageAsyncTask:
 ...
 * *************************************
 *
 * <p>ImageAsyncTask enables proper and easy use of the UI thread. This class allows to
 * perform background operations and publish results on the UI thread without
 * having to manipulate threads and/or handlers.</p>
 *
 * <p>ImageAsyncTask is designed to be a helper class around {@link Thread} and {@link android.os.Handler}
 ...
 *
 * <h2>Usage</h2>
 * <p>ImageAsyncTask must be subclassed to be used. The subclass will override at least
 ...
 * </pre>
 *
 * <h2>ImageAsyncTask's generic types</h2>
 ...
 * work properly:</p>
 * <ul>
 *     <li>The ImageAsyncTask class must be loaded on the UI thread. This is done
 ...
 * <p>ImageAsyncTask guarantees that all callback calls are synchronized in such a way that the following
...
public abstract class ImageAsyncTask<Params, Progress, Result> {
     ...
     * ImageImageAsyncTask, however you can also use your own {@link java.util.concurrent.Executor} for custom
     * behavior.
     *
