 ...
 * @hide
 */
public class FileSystemStorageVolume implements Parcelable {
    ...
    public FileSystemStorageVolume(String path, String description, boolean removable,
    ...
    // for parcelling only
    private FileSystemStorageVolume(String path, String description, boolean removable,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FileSystemStorageVolume && mPath != null) {
            FileSystemStorageVolume volume = (FileSystemStorageVolume) obj;
    ...
    public static final Parcelable.Creator<FileSystemStorageVolume> CREATOR =
            new Parcelable.Creator<FileSystemStorageVolume>() {
                public FileSystemStorageVolume createFromParcel(Parcel in) {
                    ...
                    return new FileSystemStorageVolume(path, description,
                            removable == 1, emulated == 1, mtpReserveSpace,
                            storageId, allowMassStorage == 1, maxFileSize);
                }

                public FileSystemStorageVolume[] newArray(int size) {
                    return new FileSystemStorageVolume[size];
                }
            };
