...
import com.afzkl.development.mColorPicker.views.ColorPickerView.OnColorChangedListener;
 ...
 * and two {@link com.afzkl.development.mColorPicker.views.ColorPanelView} (the current color and the new color)
 */
