 ...
 */
public class NavigationPagerActivity extends Activity
                ...
                if (intent.getAction().compareTo(FileManagerSettings.INTENT_SETTING_CHANGED) == 0) {
                    ...
                    if (key != null) {
                        ...
                        if (key.compareTo(FileManagerSettings.
                            ...
                            if (chRooted != NavigationPagerActivity.this.mChRooted) {
                                if (chRooted) {
                                    createChRooted();
                                } else {
                                    exitChRooted();
...
//        this.mOrientation = orientation;
        ...
        this.mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                int cc = NavigationPagerActivity.this.mNavigationViews.length;
                for (int i = 0; i < cc; i++) {
                ...
                if (!restore) {
                    ...
                    if (NavigationPagerActivity.this.mChRooted) {
                        ...
                        FileSystemStorageVolume[] volumes =
                                StorageHelper.getStorageVolumes(NavigationPagerActivity.this);
                    ...
                    try {
                        ...
                        String msg =
                                getString(
                                        ...
                                        initialDir);
                        DialogHelper.showToast(NavigationPagerActivity.this, msg, Toast.LENGTH_SHORT);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.mnu_settings:
                ...
                Intent settings = new Intent(
                        NavigationPagerActivity.this, SettingsPreferences.class);
        ...
        popup.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                try {
                    ...
                    NavigationPagerActivity.this.mHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            DialogHelper.showToast(
                                    NavigationPagerActivity.this,
            ...
            DialogHelper.createYesNoDialog(
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface alertDialog, int which) {
                        ...
                        try {
                            // Change console
                            ConsoleBuilder.changeToNonPrivilegedConsole(NavigationPagerActivity.this);
